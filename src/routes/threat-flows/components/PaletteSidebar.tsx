...
export function PaletteSidebar({ paletteSearch, onSearchChange, onAddStep, paletteGroups }: PaletteSidebarProps) {
  ...
  return (
    <div className="fixed pt-4 left-4 top-28 z-20 hidden h-[calc(100vh-140px)] w-80 flex-shrink-0 overflow-hidden rounded-xl border border-[#1e222d] bg-[#0f1115]/95 shadow-[0_16px_36px_rgba(0,0,0,0.55)] backdrop-blur md:block">
      <div className="flex h-full flex-col">
        <div className="px-4 pb-3">
          <div className="relative rounded-lg border border-[#1f2430] bg-[#0c0f16] px-2 py-1.5">
            ...
            <div key={group.label} className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2">
                {group.items.map((item) => (
                  <div key={item.label} className="flex flex-col items-center justify-center gap-1 text-center">
